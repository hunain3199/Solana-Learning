import {
  ...
  (async () => {
    ...
    // === Create mint with Transfer Fee extension only ===
    const mintKeypair = Keypair.generate();
    const mintPubkey = mintKeypair.publicKey;
    
    // Calculate space needed for TransferFee extension only
    ...
    console.log("");
    console.log("📋 Note: This token was created without embedded metadata.");
    console.log("   To add metadata later, you can use the metadata.js file as a reference.");
  })();
